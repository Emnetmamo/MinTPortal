...
const Introduction = () => {
  ...
  return (
    <div className="row mt-3">
      ...
      <div className="col-md-6" style={{color: 'white', borderRadius: '40px bold', backgroundColor: '#11676d',borderRadius:"0px"}}>
      ...
      <a href="/announcements" style={{background: "gray", color: "white", border: 'none'}} className="btn btn-secondary  ms-2">See open Research Calls</a>
      </div>
