    ...
    <form>
      ...
      <section className='mt-5'>
        <div className='mb-3 d-flex  '>
          <h2 className='me-5 display-4  fw-bold text-secondary'>
            Preview
            <button
            onClick={removeAll}
        ...
        <h2 class="display-6 fw-bold text-secondary my- text-center">Accepted Files</h2>
        <ul className='mt-4 '>
          {files.map(file => (
        ...
        <h2 class="display-6 fw-bold text-secondary  my-3 text-center">Rejected Files</h2>
        <ul className='mt-4 '>
