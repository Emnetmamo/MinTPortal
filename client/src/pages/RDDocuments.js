...
const RDDocuments = () => {
  ...
  useEffect(() => {
    ...
    axios.get(process.env.REACT_APP_SERVER+'resources/rddocuments')
      .then(response => {
...
function getFileNameFromPath(filePath) {
  ...
  return (
    <div className="container m-10" >
      <br/><br/>
      <h1 className="mb-4 mt-3 font-weight-bold text-center">R&D Documents</h1>
            ...
            <div className="card rounded shadow grow-on-hover d-flex" > {/* Added grow-on-hover class */}
              <div className="row g-0">
                ...
                <div className="col  mx-5 my-2 ">
                  ...
                  <h6 className='card-PublicationDate my-2 mx-1 ' style={{color: '#ffa525'}}>{PublicationItem.date && PublicationItem.date.split('T')[0]}{' '}</h6> <h6>| </h6> <h6 className='ms-1' style={{color: '#ffa525'}}> {PublicationItem.category}</h6>
                </div>
                <Link
                  to="#"
