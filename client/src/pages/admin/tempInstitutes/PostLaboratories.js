...
function PostLaboratories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response =  axios.post('http://localhost:5001/admin/institutes/laboratories/laboratories', data);
    ...
    <div className="">
      ...
      <div className='container mt-5'>       
          ...
          <div class="col-xs-12 col-md-7 mb-5">
            <form method="POST" action="/admin/institutes/laboratories" onSubmit={handleSubmit} encType='multipart/form-data' >
                <br/> <br/>
                <h1>Post Research Laboratories</h1>
                <div class="form-group ">
                    <label className='form-label'>Laboratories Title:</label>
                    <input type="text" name="title" class="form-control " placeholder="Title" onChange={handleChange}/>                  
                </div>
                <div class="form-group ">
                    <label className='form-label'>Link Address of Laboratories:</label>
                    <input type="text" name="link" class="form-control " placeholder="URL" onChange={handleChange}/>                  
                </div>
                <div class="form-group">
                  <label for="">Description About Laboratories:</label>
                ...
                <div class="form-group ">
                    <label className='form-label'>Email Address of Laboratories:</label>
                    <input type="text" name="email" class="form-control " placeholder="Email" onChange={handleChange}/>                  
                </div>
                <div class="form-group ">
                    <label className='form-label'>Phone Number of Laboratories:</label>
...
export default PostLaboratories;