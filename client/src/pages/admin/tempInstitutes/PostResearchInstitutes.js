...
function PostResearchInstitutes() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response =  axios.post('http://localhost:5001/admin/institutes/research-institutes/research-institutes', data);
    ...
    <div className="">
      ...
      <div className='container mt-5'>       
          ...
          <div class="col-xs-12 col-md-7 mb-5">
            <form method="POST" action="/admin/institutes/research-institutes" onSubmit={handleSubmit} encType='multipart/form-data' >
                <br/> <br/>
                <h1>Post Research Institutes</h1>
                <div class="form-group ">
                    <label className='form-label'>Research Institutes Title:</label>
                    <input type="text" name="title" class="form-control " placeholder="Title" onChange={handleChange}/>                  
                </div>
                <div class="form-group ">
                    <label className='form-label'>Link Address of Research Institutes:</label>
                    <input type="text" name="link" class="form-control " placeholder="URL" onChange={handleChange}/>                  
                </div>
                <div class="form-group">
                  <label for="">Description About Research Institutes:</label>
                ...
                <div class="form-group ">
                    <label className='form-label'>Email Address of Research Institutes:</label>
                    <input type="text" name="email" class="form-control " placeholder="Email" onChange={handleChange}/>                  
                </div>
                <div class="form-group ">
                    <label className='form-label'>Phone Number of Research Institutes:</label>
...
export default PostResearchInstitutes;