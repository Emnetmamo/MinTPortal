...
import Partners from '../../../models/tempModel/partners.js'
...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    const newsLaboratoriesPath = `public/partners_images/${newLaboratoriesId}`;
...
// POST add-news
router.post('/ict-partners',Verify, (req, res) => {
